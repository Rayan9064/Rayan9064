...
### 📚 I'm currently learning advanced backend architectures, Firebase security rules, and cloud-native deployment strategies  
### 🎯 Goals: To contribute to impactful open-source projects, build scalable SaaS tools, and crack a high-paying remote internship
...
### My name is Mohammed Rayan A and I'm a full-stack web developer and cloud enthusiast from Bangalore, India. I'm currently studying at St. Francis College, Bangalore, India.<br><br>I’m passionate about building real-world applications that solve meaningful problems. I’ve worked on projects ranging from decentralized healthcare systems on Solana to dynamic LMS platforms using Next.js and Firebase. I'm currently a Web Developer Intern at Cloud Institution and serve as a Google Cloud Arcade Facilitator, guiding learners through cloud labs and discussions.<br><br>I'm always eager to learn, collaborate, and contribute to exciting open-source and startup ecosystems. 🚀
...
<div style="display: flex; align-items: center; width: 100%; display: flex; align-items: space-around; justify-content: space-around;">
<a style="align-items: center;" href="https://github.com/Rayan9064">
...
### 🔗 [MedBlock](https://medblock-olive.vercel.app)
...
### 🛒 [Mr. Brushee](https://mr-brushee.vercel.app)
A sleek, single-page e-commerce website built with **Next.js**, integrated with **Stripe** for payments, **Google Sheets** as a lightweight CMS, and **GCP** for sending secure order confirmation emails.  
